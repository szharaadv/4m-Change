...
<nav class="app-navbar">
    ...
    <div class="navbar-links">
        <a href="/../modules/dashboard/index.php" class="nav-item <?= isActive('dashboard') ?>">
            <svg width="15" height="15" viewBox="0 0 16 16" fill="currentColor">
                <path
                    d="M1 2.5A1.5 1.5 0 012.5 1h3A1.5 1.5 0 017 2.5v3A1.5 1.5 0 015.5 7h-3A1.5 1.5 0 011 5.5v-3zm8 0A1.5 1.5 0 0110.5 1h3A1.5 1.5 0 0115 2.5v3A1.5 1.5 0 0113.5 7h-3A1.5 1.5 0 019 5.5v-3zm-8 8A1.5 1.5 0 012.5 9h3A1.5 1.5 0 017 10.5v3A1.5 1.5 0 015.5 15h-3A1.5 1.5 0 011 13.5v-3zm8 0A1.5 １.５ 0 0１１０．５ ９h3A１．５ １．５ 0 ０１１５ １０．５v３A１．５ １．５ 0 ０１１３．５ １５h-3A１．５ １．５ 
            </svg>
            Dashboard
        </a>

        <a href="/../modules/changes/index.php" class="nav-item <?= isActive('changes') ?>">
            <svg width="15" height="15" viewBox="0 0 16 16" fill="currentColor">
                <path
                    d="M14.5 3a.5.5 0 01.5.5v9a.5.5 0 01-.5.5h-13a.5.5 0 01-.5-.5v-9a.5.5 0 01.5-.5h13zm-13-1A1.5 1.5 0 000 3.5v9A1.5 1.5 0 001.5 14h13a1.5 1.5 0 001.5-1.5v-9A1.5 1.5 0 0014.5 2h-13zM3 6.5a.5.5 0 01.5-.5h9a.5.5 0 010 1h-9a.5.5 0 01-.5-.5zm0 3a.5. five 
            </svg>
            History
            <?php if ($needCount > 0): ?>
        ...
        <?php if ($user && in_array($role, ['superadmin', 'admin', 'manager', 'qc'], true)): ?>
            <a href="/../modules/changes/create.php" class="nav-item <?= isActive('create') ?>">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="currentColor">
                    <path
        ...
        <?php if ($user && $role === 'superadmin'): ?>
            <a href="/../modules/users/index.php" class="nav-item <?= isActive('users') ?>">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="currentColor">
                    <path
    ...
    <div class="navbar-user">
        ...
        <?php endif; ?>
        <?php if ($user && $role === 'superadmin'): ?>
            <a href="/../modules/audit/index.php" class="nav-item <?= isActive('audit') ?>">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="currentColor">
                    <path
